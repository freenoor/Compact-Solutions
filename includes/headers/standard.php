    ...
    <div id="page" class="site">
        ...
        <header id="canvas-menu-header" class="site-header">
                ...
                <div class="container">
                    <div class="menu-here frontpage-header">
                        <nav class="navbar navbar-expand-lg navbar-light navbar-center" id="scroll-change">
                            ...
                            <a aria-label="logo" class="logo_header" href="<?php echo esc_url(home_url('/')); ?>" alt="logo">
                                <ul>
                                <li>
                                <img src="<?php echo get_bloginfo('template_directory'); ?>/src/img/white-logo.svg" alt="logo">
                                </li>
                                </ul>
                            </a>
                            <?php } ?>
            ...
            <?php elseif (is_single() ): ?>
                <div class="headerbar standard-header standard-header-single" id="headerbar">
                <div class="container">
                    <div class="menu-here frontpage-header">
                        <nav class="navbar navbar-expand-lg navbar-light navbar-center" id="scroll-change">
